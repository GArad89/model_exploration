...
def run_algo(graph,algo_name,params,stopCriteria):
    ...
    stopCri = class_(params.get('threshold',2)) #now we have an object #the 20 is the threshold TODO change later
    dendro=partition(graph,params,graph.nodes(), algo_class, stopCri)
