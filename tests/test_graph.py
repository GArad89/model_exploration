...
class Test_GraphImporter(unittest.TestCase):
    ...
    def test_import_example(self):
        self.assertIsNotNone(DGraph.read_dot(join(project_root, "engine/dot/example.dot")),"import of example.dot failed")
    ...
    def test_import_zip(self):
        self.assertIsNotNone(DGraph.read_dot(join(project_root, "engine/dot/zip.dot")),"import of zip.dot failed")
...
class Test_GraphExporter(unittest.TestCase):
    ...
    def test_import_and_export(self):
        ...
        self.assertIsNotNone(DGraph.read_dot(join(project_root, "tests/dot_export/example.dot")), "import of exported example.dot failed")
        g=DGraph.read_dot(join(project_root, "tests/dot_export/example.dot"))
    ...
    def test_builtgraph_export(self):
        ...
        self.assertIsNotNone(DGraph.read_dot(join(project_root, "tests/dot_export/g.dot")), "import of exported g.dot failed")
        g=DGraph.read_dot(join(project_root, "tests/dot_export/g.dot"))
